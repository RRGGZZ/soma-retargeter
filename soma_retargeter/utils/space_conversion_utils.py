...
_FACING_DIRECTION_TYPE_TO_STR = {
    ...
    FacingDirectionType.OURS : "ours",
}
_STR_TO_FACING_DIRECTION_TYPE = {str : type for type, str in _FACING_DIRECTION_TYPE_TO_STR.items()}
# Accept a title-cased alias for convenience.
_STR_TO_FACING_DIRECTION_TYPE["Ours"] = FacingDirectionType.OURS
...
class SpaceConverter:
    ...
    def __init__(self, facing_direction: FacingDirectionType):
        ...
        elif facing_direction == FacingDirectionType.OURS:
