...
@dataclass
class AdamPro29DOF_CSVConfig:
    name: str = "adam_pro_29dof"
    csv_header: ClassVar[List[str]] = [
        "Frame",
        "root_translateX", "root_translateY", "root_translateZ",
        "root_rotateX", "root_rotateY", "root_rotateZ",
        "hipPitch_Left_dof", "hipRoll_Left_dof", "hipYaw_Left_dof",
        "kneePitch_Left_dof", "anklePitch_Left_dof", "ankleRoll_Left_dof",
        "hipPitch_Right_dof", "hipRoll_Right_dof", "hipYaw_Right_dof",
        "kneePitch_Right_dof", "anklePitch_Right_dof", "ankleRoll_Right_dof",
        "waistRoll_dof", "waistPitch_dof", "waistYaw_dof",
        "shoulderPitch_Left_dof", "shoulderRoll_Left_dof", "shoulderYaw_Left_dof",
        "elbow_Left_dof", "wristYaw_Left_dof", "wristPitch_Left_dof", "wristRoll_Left_dof",
        "shoulderPitch_Right_dof", "shoulderRoll_Right_dof", "shoulderYaw_Right_dof",
        "elbow_Right_dof", "wristYaw_Right_dof", "wristPitch_Right_dof", "wristRoll_Right_dof",
    ]
...
class Kai53DOF_CSVConfig:
    ...
    csv_header: ClassVar[List[str]] = [
        ...
        "left_knee_joint", "left_ankle_pitch_joint4", "left_ankle_roll_joint", "left_toe_joint",
        "right_hip_pitch_joint", "right_hip_roll_joint", "right_hip_yaw_joint",
        "right_knee_joint", "right_ankle_pitch_joint4", "right_ankle_roll_joint", "right_toe_joint",
        "waist_lower_yaw_joint", "waist_lower_pitch_joint", "waist_upper_pitch_joint", "waist_roll_joint", "waist_upper_yaw_joint",
        "left_shoulder_yaw_joint", "left_shoulder_virtual_joint1", "left_shoulder_virtual_joint2",
        "left_shoulder_pitch_flange_joint", "left_arm_base_joint", "left_arm_pitch_joint", "left_arm_roll_joint", "left_arm_yaw_joint",
        "left_elbow_joint", "left_wrist_yaw_joint", "left_wrist_roll_joint", "left_wrist_pitch_joint", "left_hand_joint",
        "right_shoulder_yaw_joint", "right_shoulder_virtual_joint1", "right_shoulder_virtual_joint2",
        "right_shoulder_pitch_flange_joint", "right_arm_base_joint", "right_arm_pitch_joint", "right_arm_roll_joint", "right_arm_yaw_joint",
        "right_elbow_joint", "right_wrist_yaw_joint", "right_wrist_roll_joint", "right_wrist_pitch_joint", "right_hand_joint",
        "chest_imu_joint", "neck_base_joint", "neck_lower_pitch_joint", "neck_upper_pitch_joint", "neck_roll_joint", "neck_yaw_joint",
        "head_imu_joint", "imu_joint",
    ]
